...
Real(dp) :: mHu21L 
Real(dp) :: mHu22L 
Complex(dp) :: ml2Tree(3, 3) 
Complex(dp) :: ml21L(3, 3) 
Complex(dp) :: ml22L(3, 3) 
Complex(dp) :: mv2Tree(3, 3) 
Complex(dp) :: mv21L(3, 3) 
Complex(dp) :: mv22L(3, 3) 
...
Real(dp) :: g1IN,g2IN,g3IN,mHd2IN,mHu2IN,mlHd2IN(3)

Complex(dp) :: YdIN(3,3),YeIN(3,3),lamIN(3),YvIN(3,3),YuIN(3,3),kapIN(3,3,3),TdIN(3,3),              & 
& TeIN(3,3),TlamIN(3),TvIN(3,3),TuIN(3,3),TkIN(3,3,3),mq2IN(3,3),ml2IN(3,3),             & 
& md2IN(3,3),mu2IN(3,3),me2IN(3,3),mv2IN(3,3),M1IN,M2IN,M3IN

Real(dp) :: g1MZ,g2MZ,g3MZ,mHd2MZ,mHu2MZ,mlHd2MZ(3)

Complex(dp) :: YdMZ(3,3),YeMZ(3,3),lamMZ(3),YvMZ(3,3),YuMZ(3,3),kapMZ(3,3,3),TdMZ(3,3),              & 
& TeMZ(3,3),TlamMZ(3),TvMZ(3,3),TuMZ(3,3),TkMZ(3,3,3),mq2MZ(3,3),ml2MZ(3,3),             & 
& md2MZ(3,3),mu2MZ(3,3),me2MZ(3,3),mv2MZ(3,3),M1MZ,M2MZ,M3MZ

Real(dp) :: g1GUT,g2GUT,g3GUT,mHd2GUT,mHu2GUT,mlHd2GUT(3)

Complex(dp) :: YdGUT(3,3),YeGUT(3,3),lamGUT(3),YvGUT(3,3),YuGUT(3,3),kapGUT(3,3,3),TdGUT(3,3),       & 
& TeGUT(3,3),TlamGUT(3),TvGUT(3,3),TuGUT(3,3),TkGUT(3,3,3),mq2GUT(3,3),ml2GUT(3,3),      & 
& md2GUT(3,3),mu2GUT(3,3),me2GUT(3,3),mv2GUT(3,3),M1GUT,M2GUT,M3GUT
...
Real(dp) :: vdIN,vuIN,vRIN(3),vLIN(3)

Real(dp) :: vdFix,vuFix,vRFix(3),vLFix(3)

Real(dp) :: gPSd(6,2880),gTSd(6),BRSd(6,2880),gPSu(6,2880),gTSu(6),BRSu(6,2880),gPhh(8,359),      & 
...
Real(dp) :: ratioCha(8,5),ratioFd(8,3),ratioFu(8,3),ratioHpm(8,8),ratioSd(8,6),ratioSu(8,6),      & 
& ratioVWm(8)

Complex(dp) :: ratioGG(8),ratioPP(8)

Real(dp) :: ratioPCha(8,5),ratioPFd(8,3),ratioPFu(8,3),ratioPHpm(8,8),ratioPSd(8,6),              & 
& ratioPSu(8,6),ratioPVWm(8)

Complex(dp) :: ratioPGG(8),ratioPPP(8)

Real(dp) :: gForTadpoles(394)
Complex(dp) :: tForTadpoles(8)
Real(dp) :: g1_saveEP 
Real(dp) :: g2_saveEP 
...
Real(dp) :: CS_Higgs_LHC(2,8,5) 
 
Real (dp) :: MhhL(8), Mhh2L(8) 
Real (dp) :: Mhh_s(8), Mhh2_s(8) 
Real (dp) :: MAhL(8), MAh2L(8) 
Real (dp) :: MAh_s(8), MAh2_s(8) 
...
Logical, save :: InputValueformlHd2 =.False. 
...
! For HiggsBounds 
Real(dp) :: BR_tHb(8)
Real(dp) :: BR_Hcs(8), BR_Hcb(8), BR_Htaunu(8), BR_tWb
Real(dp) :: BRHHH(8,8), BRHAA(8,8) 
Real(dp) :: BRAHH(8,8), BRAAA(8,8) 
Real(dp) :: BRinvH(8), BRinvA(8) 
Real(dp) :: rHB_P_P_Cha(8,5),rHB_P_S_Cha(8,5),rHB_S_S_Cha(8,5),rHB_S_P_Cha(8,5)
Real(dp) :: rHB_P_P_Fu(8,3),rHB_P_S_Fu(8,3),rHB_S_S_Fu(8,3),rHB_S_P_Fu(8,3)
Real(dp) :: rHB_P_P_Fd(8,3),rHB_P_S_Fd(8,3),rHB_S_S_Fd(8,3),rHB_S_P_Fd(8,3)
Real(dp) :: rHB_P_VP(8),rHB_S_VP(8)
Real(dp) :: rHB_P_VZ(8),rHB_S_VZ(8)
Real(dp) :: rHB_P_VG(8),rHB_S_VG(8)
Real(dp) :: rHB_P_VWm(8),rHB_S_VWm(8)
Real(dp) :: rHB_P_P_Chi(8,10),rHB_P_S_Chi(8,10),rHB_S_S_Chi(8,10),rHB_S_P_Chi(8,10)
Complex(dp) :: CPL_A_H_Z(8,8) 
Complex(dp) :: CPL_H_H_Z(8,8) 
Complex(dp) :: CoupHPP(8), CoupHGG(8) 
Complex(dp) :: CPL_A_A_Z(8,8) 
Complex(dp) :: CoupAPP(8), CoupAGG(8) 

Real(dp) :: HPPloopVWm(8)
Real(dp) :: HPPloopSd(6,8)
Real(dp) :: HPPloopSu(6,8)
Real(dp) :: HPPloopHpm(8,8)
Real(dp) :: HPPloopCha(5,8)
Real(dp) :: HPPloopFd(3,8)
Real(dp) :: HPPloopFu(3,8)
...
End Module Model_Data_munuSSM3G
