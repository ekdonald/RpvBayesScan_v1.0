...
Module FlavorKit_Observables_munuSSM3G 
Use Control 
...
Implicit None 
Complex(dp) :: OH2lSL(5,5,8),OH2lSR(5,5,8)
...
Implicit None 
Complex(dp) :: K1L(5,5),K1R(5,5),K2L(5,5),K2R(5,5),O4lSLL(5,5,5,5),O4lSRR(5,5,5,5),O4lSRL(5,5,5,5),  & 
& O4lSLR(5,5,5,5),O4lVRR(5,5,5,5),O4lVLL(5,5,5,5),O4lVRL(5,5,5,5),O4lVLR(5,5,5,5),       & 
& O4lTLL(5,5,5,5),O4lTRR(5,5,5,5)
...
Complex(dp) :: K1L(5,5),K1R(5,5),K2L(5,5),K2R(5,5),O4lSLL(5,5,5,5),O4lSRR(5,5,5,5),O4lSRL(5,5,5,5),  & 
& O4lSLR(5,5,5,5),O4lVRR(5,5,5,5),O4lVLL(5,5,5,5),O4lVRL(5,5,5,5),O4lVLR(5,5,5,5),       & 
& O4lTLL(5,5,5,5),O4lTRR(5,5,5,5),O4lSLLcross(5,5,5,5),O4lSRRcross(5,5,5,5),             & 
& O4lSRLcross(5,5,5,5),O4lSLRcross(5,5,5,5),O4lVRRcross(5,5,5,5),O4lVLLcross(5,5,5,5),   & 
& O4lVRLcross(5,5,5,5),O4lVLRcross(5,5,5,5),O4lTLLcross(5,5,5,5),O4lTRRcross(5,5,5,5)
...
Implicit None 
Complex(dp) :: K1L(5,5),K1R(5,5),K2L(5,5),K2R(5,5),OllddSLL(5,5,3,3),OllddSRR(5,5,3,3),              & 
& OllddSRL(5,5,3,3),OllddSLR(5,5,3,3),OllddVRR(5,5,3,3),OllddVLL(5,5,3,3),               & 
& OllddVRL(5,5,3,3),OllddVLR(5,5,3,3),OllddTLL(5,5,3,3),OllddTLR(5,5,3,3),               & 
& OllddTRL(5,5,3,3),OllddTRR(5,5,3,3),OlluuSLL(5,5,3,3),OlluuSRR(5,5,3,3),               & 
& OlluuSRL(5,5,3,3),OlluuSLR(5,5,3,3),OlluuVRR(5,5,3,3),OlluuVLL(5,5,3,3),               & 
& OlluuVRL(5,5,3,3),OlluuVLR(5,5,3,3),OlluuTLL(5,5,3,3),OlluuTLR(5,5,3,3),               & 
& OlluuTRL(5,5,3,3),OlluuTRR(5,5,3,3)
...
Implicit None 
Complex(dp) :: OZ2lSL(5,5),OZ2lSR(5,5),OZ2lVL(5,5),OZ2lVR(5,5)
...
& OddllSLLSM(3,3,5,5),OddllSRRSM(3,3,5,5),OddllSRLSM(3,3,5,5),OddllSLRSM(3,3,5,5),       & 
...
Implicit None 
Complex(dp) :: OddllVRR(3,3,5,5),OddllVLL(3,3,5,5),OddllVRL(3,3,5,5),OddllVLR(3,3,5,5),              & 
& CC7(3,3),CC7p(3,3),OddllVRRSM(3,3,5,5),OddllVLLSM(3,3,5,5),OddllVRLSM(3,3,5,5),        & 
& OddllVLRSM(3,3,5,5),CC7SM(3,3),CC7pSM(3,3)
...
Implicit None 
Complex(dp) :: OddvvVRR(3,3,10,10),OddvvVLL(3,3,10,10),OddvvVRL(3,3,10,10),OddvvVLR(3,3,10,10),      & 
...
Implicit None 
Complex(dp) :: OddllVRR(3,3,5,5),OddllVLL(3,3,5,5),OddllVRL(3,3,5,5),OddllVLR(3,3,5,5),              & 
& CC7(3,3),CC7p(3,3),CC8(3,3),CC8p(3,3),OddllVRRSM(3,3,5,5),OddllVLLSM(3,3,5,5),         & 
& OddllVRLSM(3,3,5,5),OddllVLRSM(3,3,5,5),CC7SM(3,3),CC7pSM(3,3),CC8SM(3,3),             & 
& CC8pSM(3,3)
...
& O4dTLR(3,3,3,3),O4dTRL(3,3,3,3),O4dTRR(3,3,3,3),OH2qSL(3,3,8),OH2qSR(3,3,8),           & 
& OAh2qSL(3,3,8),OAh2qSR(3,3,8)
...
Implicit None 
Complex(dp) :: OdulvSLL(3,3,10,5),OdulvSRR(3,3,10,5),OdulvSRL(3,3,10,5),OdulvSLR(3,3,10,5),          & 
& OdulvVRR(3,3,10,5),OdulvVLL(3,3,10,5),OdulvVRL(3,3,10,5),OdulvVLR(3,3,10,5),           & 
...
!rruiz
! print*,i1,i2, gt1,gt2,OdulvVLLSM(gt1,gt2,i1,i2),OdulvVLRSM(gt1,gt2,i1,i2) 
...
End Function C1C2 
End Module FlavorKit_Observables_munuSSM3G 
