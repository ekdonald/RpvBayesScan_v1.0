...
& M1,M2,M3,vd,vu,vL,vR,gSdAhChaFu,gSdAhChiFd,gSdAhFdGlu,gSdSuChaChi,gSdChaFdcHpm,        & 
...
& gSdHpmFuGlu,gSdGluGluSd,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
Complex(dp) :: cplAhSdcSd(8,6,6),cplcChacFuSdL(5,3,6),cplcChacFuSdR(5,3,6),cplcChaChaAhL(5,5,8),     & 
...
Real(dp),Intent(inout) :: gSdAhChaFu(6,8,5,3),gSdAhChiFd(6,8,10,3),gSdAhFdGlu(6,8,3,1),gSdSuChaChi(6,6,5,10),   & 
& gSdChaFdcHpm(6,5,3,8),gSdhhChaFu(6,8,5,3),gSdChaGluSu(6,5,1,6),gSdSdChacCha(6,6,5,5),  & 
& gSdSdChiChi(6,6,10,10),gSdhhChiFd(6,8,10,3),gSdHpmChiFu(6,8,10,3),gSdChiGluSd(6,10,1,6),& 
& gSdFdFdcSd(6,3,3,6),gSdFuFdcSu(6,3,3,6),gSdHpmFdcCha(6,8,3,5),gSdSdFdcFd(6,6,3,3),     & 
& gSdSuFdcFu(6,6,3,3),gSdSdFucFu(6,6,3,3),gSdhhFdGlu(6,8,3,1),gSdHpmFuGlu(6,8,3,1),      & 
& gSdGluGluSd(6,1,1,6)

Real(dp) :: gSdAhChaFui(8,5,3),gSdAhChiFdi(8,10,3),gSdAhFdGlui(8,3,1),gSdSuChaChii(6,5,10),       & 
& gSdChaFdcHpmi(5,3,8),gSdhhChaFui(8,5,3),gSdChaGluSui(5,1,6),gSdSdChacChai(6,5,5),      & 
& gSdSdChiChii(6,10,10),gSdhhChiFdi(8,10,3),gSdHpmChiFui(8,10,3),gSdChiGluSdi(10,1,6),   & 
& gSdFdFdcSdi(3,3,6),gSdFuFdcSui(3,3,6),gSdHpmFdcChai(8,3,5),gSdSdFdcFdi(6,3,3),         & 
& gSdSuFdcFui(6,3,3),gSdSdFucFui(6,3,3),gSdhhFdGlui(8,3,1),gSdHpmFuGlui(8,3,1),          & 
& gSdGluGluSdi(1,1,6)
...
& me2,mv2,mlHd2,M1,M2,M3,vd,vu,vL,vR,cplAhSdcSd,cplcChacFuSdL,cplcChacFuSdR,             & 
& cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZR,   & 
& cplcChaChiHpmL,cplcChaChiHpmR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdChaSuL,cplcFdChaSuR,   & 
...
Real(dp),Intent(in) :: MAh(8),MCha(5),MFu(3),MSd(6)

Complex(dp),Intent(in) :: cplAhSdcSd(8,6,6),cplcChaChaAhL(5,5,8),cplcChaChaAhR(5,5,8),cplcFuFuAhL(3,3,8),       & 
& cplcFuFuAhR(3,3,8),cplChaFucSdL(5,3,6),cplChaFucSdR(5,3,6)
...
Real(dp),Intent(in) :: MAh(8),MChi(10),MFd(3),MSd(6)

Complex(dp),Intent(in) :: cplAhSdcSd(8,6,6),cplcFdFdAhL(3,3,8),cplcFdFdAhR(3,3,8),cplChiChiAhL(10,10,8),        & 
& cplChiChiAhR(10,10,8),cplChiFdcSdL(10,3,6),cplChiFdcSdR(10,3,6)
...
Real(dp),Intent(in) :: MAh(8),MFd(3),MGlu,MSd(6)

Complex(dp),Intent(in) :: cplAhSdcSd(8,6,6),cplcFdFdAhL(3,3,8),cplcFdFdAhR(3,3,8),cplGluFdcSdL(3,6),            & 
& cplGluFdcSdR(3,6)
...
Real(dp),Intent(in) :: MSu(6),MCha(5),MChi(10),MVWm,MHpm(8),MFu(3),MFd(3),MSd(6)

Complex(dp),Intent(in) :: cplHpmSucSd(8,6,6),cplSucSdVWm(6,6),cplcFdChaSuL(3,5,6),cplcFdChaSuR(3,5,6),          & 
& cplcFuChiSuL(3,10,6),cplcFuChiSuR(3,10,6),cplChaFucSdL(5,3,6),cplChaFucSdR(5,3,6),     & 
& cplChiChacHpmL(10,5,8),cplChiChacHpmR(10,5,8),cplChiChacVWmL(10,5),cplChiChacVWmR(10,5),& 
& cplChiFdcSdL(10,3,6),cplChiFdcSdR(10,3,6)
...
Isum = 225 
Allocate( gSum(6,5,10, Isum) ) 
Allocate( Contribution(6,5,10, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MCha(5),MFd(3),MHpm(8),MFu(3),MChi(10),MSd(6)

Complex(dp),Intent(in) :: cplcFuFdcHpmL(3,3,8),cplcFuFdcHpmR(3,3,8),cplChaFucSdL(5,3,6),cplChaFucSdR(5,3,6),    & 
& cplChiChacHpmL(10,5,8),cplChiChacHpmR(10,5,8),cplChiFdcSdL(10,3,6),cplChiFdcSdR(10,3,6)
...
Real(dp),Intent(in) :: Mhh(8),MCha(5),MFu(3),MSd(6)

Complex(dp),Intent(in) :: cplhhSdcSd(8,6,6),cplcChaChahhL(5,5,8),cplcChaChahhR(5,5,8),cplcFuFuhhL(3,3,8),       & 
& cplcFuFuhhR(3,3,8),cplChaFucSdL(5,3,6),cplChaFucSdR(5,3,6)
...
Real(dp),Intent(in) :: MCha(5),MGlu,MSu(6),MFu(3),MFd(3),MSd(6)

Complex(dp),Intent(in) :: cplcFdChaSuL(3,5,6),cplcFdChaSuR(3,5,6),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),          & 
& cplChaFucSdL(5,3,6),cplChaFucSdR(5,3,6),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6)
...
Real(dp),Intent(in) :: MSd(6),MCha(5),MVZ,MAh(8),Mhh(8),MFu(3)

Complex(dp),Intent(in) :: cplAhSdcSd(8,6,6),cplhhSdcSd(8,6,6),cplSdcSdVZ(6,6),cplcChacFuSdL(5,3,6),             & 
& cplcChacFuSdR(5,3,6),cplcChaChaAhL(5,5,8),cplcChaChaAhR(5,5,8),cplcChaChahhL(5,5,8),   & 
& cplcChaChahhR(5,5,8),cplcChaChaVZL(5,5),cplcChaChaVZR(5,5),cplChaFucSdL(5,3,6),        & 
& cplChaFucSdR(5,3,6)
...
Real(dp),Intent(in) :: MSd(6),MChi(10),MVZ,MAh(8),Mhh(8),MFd(3)

Complex(dp),Intent(in) :: cplAhSdcSd(8,6,6),cplhhSdcSd(8,6,6),cplSdcSdVZ(6,6),cplcFdChiSdL(3,10,6),             & 
& cplcFdChiSdR(3,10,6),cplChiChiAhL(10,10,8),cplChiChiAhR(10,10,8),cplChiChihhL(10,10,8),& 
...
Real(dp),Intent(in) :: Mhh(8),MChi(10),MFd(3),MSd(6)

Complex(dp),Intent(in) :: cplhhSdcSd(8,6,6),cplcFdFdhhL(3,3,8),cplcFdFdhhR(3,3,8),cplChiChihhL(10,10,8),        & 
& cplChiChihhR(10,10,8),cplChiFdcSdL(10,3,6),cplChiFdcSdR(10,3,6)
...
Real(dp),Intent(in) :: MHpm(8),MChi(10),MFu(3),MSu(6),MFd(3),MCha(5),MSd(6)

Complex(dp),Intent(in) :: cplHpmSucSd(8,6,6),cplcChaChiHpmL(5,10,8),cplcChaChiHpmR(5,10,8),cplcFdFuHpmL(3,3,8), & 
& cplcFdFuHpmR(3,3,8),cplChaFucSdL(5,3,6),cplChaFucSdR(5,3,6),cplChiFdcSdL(10,3,6),      & 
...
Real(dp),Intent(in) :: MChi(10),MGlu,MSd(6),MFd(3)
...
Real(dp),Intent(in) :: MFd(3),MSd(6),MChi(10),MGlu

Complex(dp),Intent(in) :: cplChiFdcSdL(10,3,6),cplChiFdcSdR(10,3,6),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6)
...
Real(dp),Intent(in) :: MFu(3),MFd(3),MSu(6),MCha(5),MChi(10),MGlu,MSd(6)
...
Real(dp),Intent(in) :: MHpm(8),MFd(3),MCha(5),MSu(6),MChi(10),MSd(6)

Complex(dp),Intent(in) :: cplHpmSucSd(8,6,6),cplcChaChiHpmL(5,10,8),cplcChaChiHpmR(5,10,8),cplcChaFdcSuL(5,3,6),& 
& cplcChaFdcSuR(5,3,6),cplChiFdcSdL(10,3,6),cplChiFdcSdR(10,3,6)
...
Real(dp),Intent(in) :: MSd(6),MFd(3),MVZ,MAh(8),Mhh(8),MChi(10),MGlu

Complex(dp),Intent(in) :: cplAhSdcSd(8,6,6),cplhhSdcSd(8,6,6),cplSdcSdVZ(6,6),cplcFdChiSdL(3,10,6),             & 
& cplcFdChiSdR(3,10,6),cplcFdFdAhL(3,3,8),cplcFdFdAhR(3,3,8),cplcFdFdhhL(3,3,8),         & 
& cplcFdFdhhR(3,3,8),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFdGluSdL(3,6),cplcFdGluSdR(3,6),& 
& cplChiFdcSdL(10,3,6),cplChiFdcSdR(10,3,6),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6)
...
Real(dp),Intent(in) :: MSu(6),MFd(3),MFu(3),MVWm,MHpm(8),MChi(10),MGlu,MSd(6)

Complex(dp),Intent(in) :: cplHpmSucSd(8,6,6),cplSucSdVWm(6,6),cplcFuChiSuL(3,10,6),cplcFuChiSuR(3,10,6),        & 
& cplcFuFdcHpmL(3,3,8),cplcFuFdcHpmR(3,3,8),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),       & 
& cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplChiFdcSdL(10,3,6),cplChiFdcSdR(10,3,6),         & 
...
Real(dp),Intent(in) :: MSd(6),MFu(3),MVZ,MAh(8),Mhh(8),MCha(5)

Complex(dp),Intent(in) :: cplAhSdcSd(8,6,6),cplhhSdcSd(8,6,6),cplSdcSdVZ(6,6),cplcChacFuSdL(5,3,6),             & 
& cplcChacFuSdR(5,3,6),cplcFuFuAhL(3,3,8),cplcFuFuAhR(3,3,8),cplcFuFuhhL(3,3,8),         & 
& cplcFuFuhhR(3,3,8),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplChaFucSdL(5,3,6),              & 
& cplChaFucSdR(5,3,6)
...
Real(dp),Intent(in) :: Mhh(8),MFd(3),MGlu,MSd(6)

Complex(dp),Intent(in) :: cplhhSdcSd(8,6,6),cplcFdFdhhL(3,3,8),cplcFdFdhhR(3,3,8),cplGluFdcSdL(3,6),            & 
& cplGluFdcSdR(3,6)
...
Real(dp),Intent(in) :: MHpm(8),MFu(3),MGlu,MSu(6),MFd(3),MSd(6)

Complex(dp),Intent(in) :: cplHpmSucSd(8,6,6),cplcFdFuHpmL(3,3,8),cplcFdFuHpmR(3,3,8),cplGluFdcSdL(3,6),         & 
...
End Module Sd3Decays_munuSSM3G 
