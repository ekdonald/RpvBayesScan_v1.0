...
Subroutine munussm(rank, LFlags, munuMSSM, NuisPar, Spectrum, Coll, Err)
...
Real(dp) :: vev, sinw2
Logical :: ISR(p_max)=.False., debug=.False.
Logical :: CalcTBD
...
Real(dp) :: m2solNH, m2atmNH, m2solIH, m2atmIH, myparam
Integer :: i
character(len=20) :: ranks, rankstr

!Setting the paths 
character(len=1000) :: mydir, pathsph, mydirtemp, pathsphtemp

write (ranks, *) rank
rankstr = adjustl(ranks)
...
TvIN(1,1) = munuMSSM%anu !mismo valor que tomaron ellos para todas las T
TvIN(2,2) = munuMSSM%anu
TvIN(3,3) = munuMSSM%anu
...
!
Spectrum%sth12sq = sinsqth12
Spectrum%sth13sq = sinsqth13
Spectrum%sth23sq = sinsqth23
!
m1sq = MChi(1)**2
m2sq = MChi(2)**2
m3sq = MChi(3)**2
...
IF (m23sq.gt.m12sq) THEN
 ...
 m2atmNH = m23sq
 myparam = 1d0
 Spectrum%m2sol = m2solNH
 Spectrum%m2at = m2atmNH
ELSEIF (m23sq.lt.m12sq) THEN
 m2solIH = m23sq
 m2atmIH = m12sq
 myparam = -1d0
 Spectrum%m2sol = m2solIH
 Spectrum%m2at = m2atmIH
ENDIF

Spectrum%neutrinoh = myparam
...
!! HiggsBounds Files & HiggsSignals

call getcwd(mydirtemp) 
pathsphtemp = mydirtemp

! storing directory to write Higgsbounds files
CALL chdir("../contributions/higgsbounds-5.10.2/example_data/HBout3G/")
call getcwd(mydir) 
pathsph = mydir

! change back to original directory
CALL chdir(trim(pathsphtemp))
...
Subroutine HiggsBounds
Implicit None
integer :: j
character (len=300) :: hbfilepath

!hbfilepath = "./contributions/higgsbounds-5.10.2/example_data/HBout3G/HB3-"
hbfilepath = trim(pathsph)//"/contributions/higgsbounds-5.10.2/example_data/HBout3G/"

Open(87,file= trim(hbfilepath)//"HB3-MH_GammaTot_"//trim(rankstr)//".dat",status="unknown")
Open(88,file= trim(hbfilepath)//"HB3-MHplus_GammaTot_"//trim(rankstr)//".dat",status="unknown")
Open(89,file= trim(hbfilepath)//"HB3-effC_"//trim(rankstr)//".dat",status="unknown")
Open(90,file= trim(hbfilepath)//"HB3-BR_H_NP_"//trim(rankstr)//".dat",status="unknown")
Open(91,file= trim(hbfilepath)//"HB3-BR_Hplus_"//trim(rankstr)//".dat",status="unknown")
Open(92,file= trim(hbfilepath)//"HB3-BR_t_"//trim(rankstr)//".dat",status="unknown")
Open(93,file= trim(hbfilepath)//"HB3-LEP_HpHm_CS_ratios_"//trim(rankstr)//".dat",status="unknown")
Open(94,file= trim(hbfilepath)//"HB3-MHall_uncertainties_"//trim(rankstr)//".dat",status="unknown")
Open(95,file= trim(hbfilepath)//"HB3-BR_H_OP_"//trim(rankstr)//".dat",status="unknown")
Open(96,file= trim(hbfilepath)//"HB3-LHC13_Hplus_hadCS_"//trim(rankstr)//".dat",status="unknown")
Open(97,file= trim(hbfilepath)//"HB3-LHC8_Hplus_hadCS_"//trim(rankstr)//".dat",status="unknown")
...
Write(90,"(e16.8)",advance="No") BRhh(3,33)
...
Write(90,"(e16.8)",advance="No") BRhh(4,33)
...
Write(90,"(e16.8)",advance="No") BRhh(5,33)
...
Write(90,"(e16.8)",advance="No") BRhh(6,33)
...
Write(90,"(e16.8)",advance="No") BRAh(2,185)
...
Write(90,"(e16.8)",advance="No") BRAh(3,185)
...
Write(90,"(e16.8)",advance="No") BRAh(4,185)
...
Write(90,"(e16.8)",advance="No") BRAh(5,185)
...
Write(90,"(e16.8)",advance="No") BRAh(6,185)
...
Write(90,"(e16.8)",advance="No") BRAh(7,185)
...
Write(90,"(e16.8)",advance="No") BRAh(8,185)
...
Write(90,"(e16.8)",advance="No") 0._dp
Write(90,"(e16.8)",advance="No") 0._dp
Write(90,"(e16.8)",advance="No") BRhh(1,89)
...
write(90,"(e16.8)",advance="No") BRAh(2,221)
...
Write(90,"(e16.8)",advance="No") 0._dp
Write(90,"(e16.8)",advance="No") 0._dp
Write(90,"(e16.8)",advance="No") BRAh(3,221)
...
Write(90,"(e16.8)",advance="No") 0._dp
Write(90,"(e16.8)",advance="No") 0._dp
Write(90,"(e16.8)",advance="No") BRAh(4,221)
...
Write(90,"(e16.8)",advance="No") 0._dp
Write(90,"(e16.8)",advance="No") 0._dp
Write(90,"(e16.8)",advance="No") BRAh(5,221)
...
Write(90,"(e16.8)",advance="No") 0._dp
Write(90,"(e16.8)",advance="No") 0._dp
Write(90,"(e16.8)",advance="No") BRAh(6,221)
...
Write(90,"(e16.8)",advance="No") 0._dp
Write(90,"(e16.8)",advance="No") 0._dp
Write(90,"(e16.8)",advance="No") BRAh(7,221)
...
Write(90,"(e16.8)",advance="No") 0._dp
Write(90,"(e16.8)",advance="No") 0._dp
Write(90,"(e16.8)",advance="No") BRAh(8,221)
...
Write(90,"(e16.8)",advance="No") 0._dp
Write(90,"(e16.8)",advance="No") 0._dp
Write(90,"(e16.8)",advance="No") BRhh(1,97)
...
Write(90,"(e16.8)",advance="No") BRAh(2,88)
...
Write(90,"(e16.8)",advance="No") BRhh(1,279)
...
Write(90,"(e16.8)",advance="No") BRhh(2,279)
...
Write(90,"(e16.8)",advance="No") BRhh(3,279)
...
Write(90,"(e16.8)",advance="No") BRhh(4,279)
...
Write(90,"(e16.8)",advance="No") BRhh(5,279)
...
Write(90,"(e16.8)",advance="No") BRhh(6,279)
...
Write(90,"(e16.8)",advance="No") BRhh(7,279)
...
Write(90,"(e16.8)",advance="No") BRhh(8,279)
...
Write(90,"(e16.8)",advance="No") BRAh(2,278)
...
Write(90,"(e16.8)",advance="No") BRAh(3,278)
...
Write(90,"(e16.8)",advance="No") BRAh(4,278)
...
Write(90,"(e16.8)",advance="No") BRAh(5,278)
...
Write(90,"(e16.8)",advance="No") BRAh(6,278)
...
Write(90,"(e16.8)",advance="No") BRAh(7,278)
...
Write(90,"(e16.8)",advance="No") BRAh(8,278)
...
Write(95,"(e16.8)",advance="No") BRhh(1,180)
...
Write(95,"(e16.8)",advance="No") BRAh(2,171)
...
Write(95,"(e16.8)",advance="No") BRhh(1,189)
...
Write(95,"(e16.8)",advance="No") BRAh(2,180)
...
Write(95,"(e16.8)",advance="No") BRhh(1,184)
...
Write(95,"(e16.8)",advance="No") BRAh(2,175)
...
Write(95,"(e16.8)",advance="No") BRhh(1,193)
...
Write(95,"(e16.8)",advance="No") BRAh(2,184)
...
Write(95,"(e16.8)",advance="No") BRhh(7,193)
Write(95,"(e16.8)",advance="No") BRhh(8,193)
Write(95,"(e16.8)",advance="No") BRAh(2,93)
...
Write(95,"(e16.8)",advance="No") BRhh(1,108)
...
Write(95,"(e16.8)",advance="No") BRAh(2,99)
...
Write(95,"(e16.8)",advance="No") BRhh(1,4)
...
Write(95,"(e16.8)",advance="No") 0._dp
Write(95,"(e16.8)",advance="No") 0._dp
Write(95,"(e16.8)",advance="No") BRhh(1,3)
...
Write(95,"(e16.8)",advance="No") 0._dp
Write(95,"(e16.8)",advance="No") 0._dp
Write(95,"(e16.8)",advance="No") BRhh(1,1)
...
Write(95,"(e16.8)",advance="No") BRAh(2,1)
...
Write(95,"(e16.8)",advance="No") BRhh(1,2)
...
Write(95,"(e16.8)",advance="No") BRAh(2,2)
...
Open(87,file= trim(hbfilepath)//"MH_GammaTot_"//trim(rankstr)//".dat",status="unknown")
Open(88,file= trim(hbfilepath)//"MHplus_GammaTot_"//trim(rankstr)//".dat",status="unknown")
Open(89,file= trim(hbfilepath)//"effC_"//trim(rankstr)//".dat",status="unknown")
Open(90,file= trim(hbfilepath)//"BR_H_NP_"//trim(rankstr)//".dat",status="unknown")
Open(91,file= trim(hbfilepath)//"BR_Hplus_"//trim(rankstr)//".dat",status="unknown")
Open(92,file= trim(hbfilepath)//"BR_t_"//trim(rankstr)//".dat",status="unknown")
Open(93,file= trim(hbfilepath)//"LEP_HpHm_CS_ratios_"//trim(rankstr)//".dat",status="unknown")
Open(94,file= trim(hbfilepath)//"MHall_uncertainties_"//trim(rankstr)//".dat",status="unknown")
Open(95,file= trim(hbfilepath)//"BR_H_OP_"//trim(rankstr)//".dat",status="unknown")
...
Write(94,"(I1)",advance="No") 1
 DO j = 1, 8
    if(122 .lt. Mhh(j) .and. Mhh(j) .lt. 128) then
      Write(94,"(e16.8)",advance="No") 3.0000
    else
      Write(94,"(e16.8)",advance="No") 0.0000
    endif
...
Write(95,"(e16.8)",advance="No") BRAh(8,2)
 ...
 Close(94)
 Close(95)
End Subroutine HiggsBounds_old
