...
Implicit None 
Real(dp), Intent(in) :: mh(8)  
Complex(dp), Intent(in) :: ratPP(8), ratGG(8)  
Real(dp), Intent(in) :: ratZZ(8), ratWW(8), ratTT(8)  
Real(dp), Intent(Out) :: CS(2,8,5)  
