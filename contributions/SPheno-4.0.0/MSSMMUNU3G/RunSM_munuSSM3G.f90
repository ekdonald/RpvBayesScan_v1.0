...
& me2,mv2,mlHd2,M1,M2,M3,vd,vu,vL,vR,CKMout,sinW2_out,Alpha_out,AlphaS_out,realCKM)
...
Real(dp) :: scale_save, Qin, tz, dt, g1D(394), g62_SM(62) 
 
 
! Run SUSY RGEs from M_SUSY to Qin 
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call ParametersToG394(g1input,g2input,g3input,Ydinput,Yeinput,laminput,               & 
...
& mlHd2input,M1input,M2input,M3input,vdinput,vuinput,vLinput,vRinput,g1D)
...
vev2=mZ2*CosW2SinW2/(pi*Alpha_mZ) -2*(vL(1)**2 + vL(2)**2 + vL(3)**2) 
vevSM = sqrt(vev2) 
